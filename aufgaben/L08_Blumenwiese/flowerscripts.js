...
(function (Blumenwiese) {
    ...
    function drawBackground() {
        ...
        gradient.addColorStop(0.4, "#CCEEFF");
    ...
    function drawDaisy() {
        ...
        crc2.strokeStyle = "#103517";
        crc2.stroke();
        crc2.beginPath();
        moveTo(10, 20);
        crc2.arc(0, 0, 6, 0, 2 * Math.PI);
        crc2.fillStyle = "#FCF238";
        crc2.strokeStyle = "##FCF238";
        crc2.fill();
        crc2.stroke();
        for (let blossoms = 80; blossoms > 8; blossoms -= 8) {
            ...
            crc2.fillStyle = "#FD9300";
            crc2.strokeStyle = "#FD9300";
            crc2.fill();
            crc2.stroke();
        }
        crc2.restore();
    ...
    function drawTulip() {
        ...
        crc2.fillStyle = "#BB0808";
        crc2.strokeStyle = "##BB0808";
        crc2.fill();
        crc2.stroke();
        moveTo(0, 20);
        crc2.lineTo(-10, -10);
...
//# sourceMappingURL=flowerscripts.js.map