...
(function (A10_BlumenwiesePolymorphie) {
    ...
    function drawBackgroundSky() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 400); //create Gradient
    ...
    function drawBackgroundGrass() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 700); //create Gradient
    ...
    function drawMountain1() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 200); //create Gradient
    ...
    function drawMountain3() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 220); //create Gradient
        grd.addColorStop(0, "white");
    ...
    //Busch
    function drawBush1() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 430); //create Gradient
    ...
    function drawBush2() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 530); //create Gradient
        grd.addColorStop(0, "#A5DF00");
        grd.addColorStop(1, "#298A08");
        A10_BlumenwiesePolymorphie.crc2.beginPath();
        A10_BlumenwiesePolymorphie.crc2.fillStyle = grd;
    ...
    function drawBush4() {
        let grd = A10_BlumenwiesePolymorphie.crc2.createLinearGradient(0, 0, 0, 450); //create Gradient
        grd.addColorStop(0, "#A5DF00");
        grd.addColorStop(1, "#298A08");
        A10_BlumenwiesePolymorphie.crc2.beginPath();
        A10_BlumenwiesePolymorphie.crc2.fillStyle = grd;
