...
(function (L09_Bienenwiese) {
    class Flower {
        ...
        // damit draw funktioniert, random Style vergeben zwischen 1 und 2
        setRandomStyle() {
        ...
        drawDaisy() {
            ...
            L09_Bienenwiese.crc2.strokeStyle = "#103517";
            L09_Bienenwiese.crc2.stroke();
            L09_Bienenwiese.crc2.beginPath();
            moveTo(10, 20);
            L09_Bienenwiese.crc2.arc(0, 0, 6, 0, 2 * Math.PI);
            L09_Bienenwiese.crc2.fillStyle = "#FCF238";
            L09_Bienenwiese.crc2.strokeStyle = "#FCF238";
            ...
            for (let blossoms = 80; blossoms > 8; blossoms -= 8) {
                ...
                L09_Bienenwiese.crc2.fillStyle = "#FD9300";
                L09_Bienenwiese.crc2.strokeStyle = "#FD9300";
                L09_Bienenwiese.crc2.fill();
                L09_Bienenwiese.crc2.stroke();
            }
        ...
        drawTulip() {
            ...
            L09_Bienenwiese.crc2.fillStyle = "#BB0808";
            L09_Bienenwiese.crc2.strokeStyle = "#BB0808";
            L09_Bienenwiese.crc2.fill();
            L09_Bienenwiese.crc2.stroke();
            moveTo(0, 20);
